        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $anh_bia_path = "uploads/" . $anh_bia;
                            if (!file_exists($anh_bia_path)) {
                                $anh_bia_path = "uploads/default.jpg"; // Nếu không có ảnh, sử dụng ảnh mặc định
                            }
                    ?>
                            <div class="col-md-6 mb-4">
                                <div class="card">
                                    <img src="<?= $anh_bia_path; ?>" class="card-img-top" alt="Article Image">
                                    <div class="card-body">
                                        <h5 class="card-title"><?= $tieu_de; ?></h5>
                                        <p class="card-text"><?= $noi_dung; ?>...</p>
                                        <a href="article.php?id=<?= $id; ?>" class="btn btn-primary">Đọc thêm</a>
                                    </div>
                                </div>
                            </div>
                    <?php
            ...
            <div class="col-lg-4">
                ...
                <ul class="list-group mb-4">
                    ...
                    ?>
                            <li class="list-group-item">
                                <a href="article.php?id=<?= $id_featured; ?>"><?= $tieu_de_featured; ?></a>
                            </li>
                    <?php
                        }
                    } else {
                ...
                <ul class="list-group">
                    ...
                    ?>
                            <li class="list-group-item">
                                <a href="index.php?id=<?= $id_category; ?>"><?= $ten_danh_muc; ?></a>
                            </li>
                    <?php
                        }
                    } else {
